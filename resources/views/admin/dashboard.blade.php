...
@section('content')
    <div class="p-4 sm:p-6 lg:p-10">
        ...
        <div class="grid  grid-cols-1 lg:grid-cols-[2fr_1fr] mt-4  md:mt-0 gap-10">
                ...
                <div class="bg-white p-5 rounded-lg">
                    ...
                    <div class="grid grid-cols-2 gap-5  mt-5">
                        ...
                        <a href=""
                            ...
                            <img class="block mx-auto" src="{{ asset('assets/icons/staging-icon.png') }}"
                                alt="">
                            <p>Add Staging</p>
                        </a>
                        <a href=""
                        ...
                        <a href=""
                            ...
                            <img class="block mx-auto" src="{{ asset('assets/icons/request-icon.png') }}"
                                alt="">
                            <p>Buy request</p>
                        </a>
                    </div>
