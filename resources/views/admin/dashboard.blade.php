    ...
    <div class="p-4 sm:p-6 lg:p-10">
        ...
        <div class="grid  md:grid-cols-2 lg:grid-cols-4 gap-5 lg:gap-10 my-2  md:my-5 lg:my-6">
            ...
            <div class="bg-white p-4 rounded-md shadow-sm hover:shadow-md transition cursor-pointer">
                ...
                <div class="pt-8">
                    <h6 class="text-[#B5B5C3]">Total staff</h6>
                    <h1 class="text-2xl font-bold">1,234</h1>
                </div>
        ...
        <div class="grid  grid-cols-1 lg:grid-cols-[2fr_1fr] mt-4  md:mt-0 gap-10 items-start">
            <div class="bg-white p-4 rounded-lg">
                <div class=" flex justify-between border-b pb-4">
                    ...
                    <a href="" class="flex items-center">View All <img
                            src="{{ asset('assets/icons/arrow-right.png') }}" alt="arrow-pointing to the right"></a>
                </div>
                ...
                <div class="mt-5">
                    ...
                    {{-- <div class="sm:flex sm:justify-between items-center my-3 bg-secondary py-2 px-3 rounded-md">
                        <div class="flex gap-3">
                            <img src="{{ asset('assets/images/image-property.png') }}" alt="image-property">
                        <div>
                        <p class="font-bold truncate">Seaside Serenity Villa</p>
                        <div class="flex items-center">
                            <img src="{{ asset('assets/icons/map-point.png') }}" alt="">
                            <p class="text-sm"> Malibu, California</p>
                        </div>
                    ...
                    <a href="" class="text-sm block mt-2 sm:mt-0 bg-primary text-white  px-1 py-1 text-center sm:py-2 sm:px-3 rounded-md hover:bg-primary-hover hover:shadow-md hover:scale-[1.02] transition-duration-200 active:scale-95">View
                        Details</a>
                    </div>
                    <div class="sm:flex sm:justify-between items-center my-3 bg-secondary py-2 px-3 rounded-md">
                    <div class="flex gap-3">
