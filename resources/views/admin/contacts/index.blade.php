                            ...
                            <td class="px-6 py-4">
                                ...
                                <div id="dropdownDots"
                                    ...
                                    <ul class="py-2 text-sm text-gray-700 dark:text-gray-200"
                                        ...
                                        <li>
                                            <a href="#"
                                                class="block px-4 py-2 hover:bg-gray-100 text-green-500">Confirm Booking</a>
                                        </li>
                                        <li>
                                            <a href="#"
                                                class="block px-4 py-2 text-danger hover:bg-gray-100">Delete</a>
                                        </li>
                                    </ul>
