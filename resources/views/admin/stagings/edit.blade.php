...
<div class="p-4 sm:p-6 lg:p-10">
  ...
  <x-page-header backRoute='staging.index' title="Edit Staging Details">
    <x-button href="{{ route('staging.index') }}" variant="outline">
      Discard
    </x-button>
  ...
  <div class="mt-5 lg:mt-14">
    <div class="grid grid-cols-1 md:grid-cols-[2fr_1fr] gap-5">
      <div class="bg-white p-7 rounded-lg">
        <h1 class="font-bold text-lg">stagingy Information</h1>
