                    ...
                    <div class="mt-5">
                        ...
                        <div class="flex justify-between gap-3 flex-wrap">
                            ...
                            <div class="mb-5 flex-1">
                                ...
                                <x-forms.input-select name="sell_request_id"
                                    placeholder="-- Select a sell request to attach --"
                                    :options="$pendingSellRequests" />
                        ...
                        <div class="flex justify-between gap-3 flex-wrap">
                            <div class="mb-5 flex-1">
                                ...
                                <x-forms.input-textarea name="description"
                            ...
                            <div class="mb-5 flex-1">
                                ...
                                <x-forms.input-textarea name="features"
