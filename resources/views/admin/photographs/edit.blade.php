...
@section('content')
        ...
        <form action="{{ route('photographs.update', ['photograph' => $photograph->id]) }}" method="POST"
            ...
            <div class="mt-5 lg:mt-14">
                <div class="grid grid-cols-1 md:grid-cols-[2fr_1fr] gap-5">
                        ...
                        <div class="mt-5">
                            ...
                            <div class="flex justify-between gap-3 flex-wrap">
                                <div class="flex-1 mb-5">
                                    ...
                                    <x-forms.input name="video_url" :value="$photograph->video_url" type="text" placeholder="URL: Enter Link"
                                        :required="false" />
                                ...
                                <div class="mb-5 flex-1">
                                    ...
                                    <x-forms.input-select name="property_id" placeholder="-- Select a property to attach --"
                                        :options="$properties" :selected="$photograph->property_id" />
                            ...
                            <div>
                                ...
                                <x-forms.input-textarea name="description" :value="$photograph->description"
                    ...
                    <x-forms.image-upload-section name='thumbnail' :id="$photograph->id" :image="$photograph->imageUrl()"
                        target="delete-photograph" />
    ...
    <x-alert-modal :action="route('thumbnail.delete', ['model' => 'PropertyMedia', 'id' => $photograph->id])" variant="delete" id="delete-photograph-{{ $photograph->id }}"
        title="photograph thumbnail" method="DELETE" />
