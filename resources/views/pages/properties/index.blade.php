    ...
    <x-slot:title>
        ...
        <section id="back" class="">
            <div class="container text-md-start py-5">
                ...
                <p class="back3">
                    Welcome to Monarsh Properties, where your dream property awaits in every corner of our beautiful
                    world.
                    Explore our curated selection of properties, each offering a unique story and a chance to redefine
                    your
                        ...
                        <div class="col-12 col-md-4 p-1">
                            <div class="input-group">
                                ...
                                <select id="location-select" class="form-select form-select-sm locate"
                                    ...
                                    <option value="{{ $case->value }}" {{ old($case->value) === 'selected' ? 'selected'
                                        : '' }}>{{ $case->label() }}
                                    </option>
                                    @endforeach
                                </select>
            ...
            <div class="container mt-5">
                <div class="row">
                    ...
                    <div class="text-center">
                        <p class="text-success fs-4">No Property listed yet!!</p>
                        <a href="{{ route("sellRequest.create") }}" class="list-link fs-5">You can list your properties here by clicking here</a>
