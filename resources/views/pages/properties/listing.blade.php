        ...
        <section class="py-4 bg-light w-100">
            <div class="container px-4 px-md-5 show">
                ...
                <form action="{{ route('sellRequest.store') }}" method="POST">
                    ...
                    <!-- Property Details -->
                    <h5 class="mb-3"> <span class="cont"><i class="bi bi-house-heart-fill"></i></span>Property Details
                    </h5>
                    <div class="row mb-3">
                        <div class="col-12">
                            ...
                            <select id="property-type" class="form-select w-100" name="property_type" required>
                                ...
                                <option value="{{ $case->value }}" {{ old('property_type')==$case->value ? 'selected' :
                                    '' }}>{{ $case->label() }}
                                </option>
                                @endforeach
                            </select>
                    ...
                    <div class="row mb-4">
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control w-100" id="address"
                                placeholder="e.g., 123 Admiralty Way, Lekki Phase 1, Lagos" name="address"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-12 col-md-4 mb-3 mb-md-0">
                            ...
                            <input type="tel" class="form-control w-100" id="phone-number"
                                placeholder="+234 XXX XXX XXXX" name="phone_number" value="{{ old('phone_number') }}"
                                required>
                            <span class="text-danger">
                                @error('phone_number')
                                {{ $message }}
                    ...
                    <div class="row">
                        <div class="col-12">
                            <button id="submit" type="submit" class="btn btn-primary w-100 mt-3">Submit
                                Property</button>
                        </div>
                    </div>
                </form>
